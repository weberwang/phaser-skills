...
4. 原子资源必须绑定当前有效基线、适用分系统锚点，以及仍适用、有效、绑定版本且覆盖当前范围的低保真确认记录、高保真确认记录与视觉可交付结论。任一项无法绑定时升级 V0 路径，不得凭相似关键词或旧版批准继续生产。
...
禁止直接修改冻结基线。变更提案必须包含：旧/新基线 ID、版本与指纹；变更原因；规则和锚点差异；不变量与允许变量变化；受影响资源、状态、页面、动画、VFX、布局、证据、低保真/高保真确认记录和渠道；迁移/废弃计划；成本、授权与风险；非作者美术结论；通常按需 F4 决策及适用时独立执行的 V1/V2 出口确认。

批准新基线后，将旧证据与不再匹配的低保真/高保真确认记录标为失效或限定适用范围，并从最早受影响的 V 阶段重验。若变更影响信息结构、构图、层级、资源槽、交互或布局，退回 V1 并对新低保真候选重新确认；若改变用户可见高保真形态，则在受影响 V2b/F2 通过后另行对新高保真候选重新确认。至少重验主锚点、受影响分系统锚点、多资源联系表、同屏截图、V4 文件/Phaser 证据和 V5 运行态证据。未完成影响面重验时不得报告视觉完成。
