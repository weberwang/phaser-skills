...
场景只验收自身画面和常驻 HUD；modal/popup 等弹窗按[独立工作项规则](../../phaser4-game-workflow-control/references/control-model.md#弹窗工作项与场景解耦)完成完整上下文、两次 V2 确认、V3 和自身 V4。弹窗状态不进入场景 V4 门。
