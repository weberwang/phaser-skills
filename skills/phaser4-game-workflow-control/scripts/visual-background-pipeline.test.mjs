...
test("公共去背记录可直接接入透明合同和 Sharp 归一化", async () => {
  ...
  try {
    ...
    const removal = await removeBackgroundLocal({ sourceFile: rawFile, outputFile: sourceFile, backgroundColor: "#00aa55", tolerance: 0 });
    ...
    const generation = {
      ...
      source_file: sourceFile, source_has_alpha: true, full_prompt: "生成独立角色，最终交付透明 PNG",
