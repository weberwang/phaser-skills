    ...
    layout_nodes: [
      {
        ...
        region_id: "hud",
        coordinate_space: "viewport",
        ui_layout: { grouping_basis: ["POSITION"], layout_owner: "SELF", size_policy: "FLEX", overflow_policy: "KEEP_VISIBLE", safe_area_policy: "INSIDE_SAFE_AREA", interaction_policy: "NONE" },
